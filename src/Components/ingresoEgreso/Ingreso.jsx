...
export const CrearIngreso = () => {
  ...
  const guardarArticulo = async (e) => {
    ...
    const { datos } = await PetitionFetchToken(Global.url + "ingreso/crear", "POST", localStorage.getItem("token"), nuevo);
  ...
  return (
    <div className='jumbo'>
      ...
      <form className="formulario" onSubmit={guardarArticulo}>
        ...
        <div className="form-group">
          <label htmlFor='ingresos'>Ingreso</label>
          <input type="text" name='ingresos' onChange={cambiado} />
        </div>
        <div className="form-group">
